     ...
     <div id="user-detail">
         <div class="avatar">
             @if (!empty(Auth::guard('karyawan')->user()->foto))
                 ...
                 @endphp
                 <img src="{{ url($path) }}" alt="" class="imaged w64 rounded" style="object-fit: cover">
             @else
             @endif
     ...
     <div id="rekappresensi">
         ...
         <div class="row">
             <div class="col-3">
                 <div class="card">
                     <div class="card-body text-center" style="padding: 12px 12px | important; line-height:0.8rem">
                         <span class="badge-danger" style="position: absolute; right:10px">
             ...
             <div class="col-3">
                 <div class="card">
                     <div class="card-body text-center" style="padding: 12px 12px | important; line-height:0.8rem">
                         <span class="badge-danger" style="position: absolute; right:10px">10</span>
                 ...
                 <div class="card">
                     <div class="card-body text-center" style="padding: 12px 12px | important; line-height:0.8rem">
                         <span class="badge-danger"
                             style="position: absolute; right:10px">{{ $rekappresensi->jmlterlambat }}</span>
                     ...
                     @foreach ($historibulanini as $h)
                         ...
                         <li>
                             <div class="item">
                                 ...
                                 <div class="in">
                                     <div>{{ date('d-m-Y', strtotime($h->tgl_presensi)) }}</div>
                                     <span class="badge badge-success">{{ $h->jam_in }} </span>
                                     <span
                                         class="badge badge-danger">{{ $presensihariini != null && $h->jam_out != null ? $h->jam_out : 'Belum Absen' }}</span>
                                 </div>
                             </div>
                         </li>
                     @endforeach
